...
(X, Ytra) = make_blobs(n_samples=250, n_features=feats, centers=2,
...
x_train = X
y_train = keras.utils.to_categorical(Ytra, 2)
...
np.savetxt("D_lossepoch_mean_EVGO.csv", np.array(mean_gd), delimiter=",", fmt='%s')  
np.savetxt("D_lossepoch_mean_EVGO_cin.csv", np.array(ci_n_gd), delimiter=",", fmt='%s')  
np.savetxt("D_lossepoch_mean_EVGO_cip.csv", np.array(ci_p_gd), delimiter=",", fmt='%s')  

np.savetxt("D_final_loss_EVGO.csv", np.array(final_loss), delimiter=",", fmt='%s')
np.savetxt("D_final_acc_EVGO.csv", np.array(final_acc), delimiter=",", fmt='%s')  

np.savetxt("D_final_loss_EVGO_2d.csv", np.array(final_loss_2d), delimiter=",", fmt='%s')
np.savetxt("D_final_acc_EVGO_2d.csv", np.array(final_acc_2d), delimiter=",", fmt='%s')  
