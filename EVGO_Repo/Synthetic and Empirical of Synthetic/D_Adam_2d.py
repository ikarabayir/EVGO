...
np.savetxt("D_lossepoch_mean_Adam.csv", np.array(mean_gd), delimiter=",", fmt='%s')  
np.savetxt("D_lossepoch_mean_Adam_cin.csv", np.array(ci_n_gd), delimiter=",", fmt='%s')  
np.savetxt("D_lossepoch_mean_Adam_cip.csv", np.array(ci_p_gd), delimiter=",", fmt='%s')  

np.savetxt("D_final_loss_Adam.csv", np.array(final_loss), delimiter=",", fmt='%s')
np.savetxt("D_final_acc_Adam.csv", np.array(final_acc), delimiter=",", fmt='%s')  

np.savetxt("D_final_loss_Adam_2d.csv", np.array(final_loss_2d), delimiter=",", fmt='%s')
np.savetxt("D_final_acc_Adam_2d.csv", np.array(final_acc_2d), delimiter=",", fmt='%s')  
