...
np.savetxt("D_lossepoch_mean_GD.csv", np.array(mean_gd), delimiter=",", fmt='%s')  
np.savetxt("D_lossepoch_mean_GD_cin.csv", np.array(ci_n_gd), delimiter=",", fmt='%s')  
np.savetxt("D_lossepoch_mean_GD_cip.csv", np.array(ci_p_gd), delimiter=",", fmt='%s')  

np.savetxt("D_final_loss_GD.csv", np.array(final_loss), delimiter=",", fmt='%s')
np.savetxt("D_final_acc_GD.csv", np.array(final_acc), delimiter=",", fmt='%s')  

np.savetxt("D_final_loss_GD_2d.csv", np.array(final_loss_2d), delimiter=",", fmt='%s')
np.savetxt("D_final_acc_GD_2d.csv", np.array(final_acc_2d), delimiter=",", fmt='%s')  
