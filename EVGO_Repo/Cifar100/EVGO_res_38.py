...
np.savetxt("freya_alg4_lossepoch_r38_cifar100_reduce_sum.csv", lossepoch, delimiter=",", fmt='%s')
np.savetxt("freya_alg4_lossepoch_test_r38_cifar100_reduce_sum.csv", lossepoch_test, delimiter=",", fmt='%s')       
np.savetxt("freya_alg4_loss_tra_r38_cifar100_reduce_sum.csv", lossx, delimiter=",", fmt='%s')
np.savetxt("freya_alg4_skip_r38_cifar100_reduce_sum.csv", skip, delimiter=",", fmt='%s')
np.savetxt("freya_alg4_acc_tra_r38_cifar100_reduce_sum.csv", acctra, delimiter=",", fmt='%s')
np.savetxt("freya_alg4_loss_test_r38_cifar100_reduce_sum.csv", loss_test, delimiter=",", fmt='%s')
np.savetxt("freya_alg4_acc_test_r38_cifar100_reduce_sum.csv", acc_test, delimiter=",", fmt='%s')
