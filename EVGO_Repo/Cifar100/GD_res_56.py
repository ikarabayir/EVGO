...
np.savetxt("freya_base_lossepoch_r56_cifar100.csv", lossepoch, delimiter=",", fmt='%s')
np.savetxt("freya_base_lossepoch_test_r56_cifar100.csv", lossepoch_test, delimiter=",", fmt='%s')       
np.savetxt("freya_base_loss_tra_r56_cifar100.csv", lossx, delimiter=",", fmt='%s')
np.savetxt("freya_base_skip_r56_cifar100.csv", skip, delimiter=",", fmt='%s')
np.savetxt("freya_base_acc_tra_r56_cifar100.csv", acctra, delimiter=",", fmt='%s')
np.savetxt("freya_base_loss_test_r56_cifar100.csv", loss_test, delimiter=",", fmt='%s')
np.savetxt("freya_base_acc_test_r56_cifar100.csv", acc_test, delimiter=",", fmt='%s')
